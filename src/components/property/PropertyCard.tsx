...
import { Bed, Bath, Square, ShieldCheck, Building2, User } from 'lucide-react';
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex gap-2">
          {property.is_verified && (
            <span className="flex items-center gap-1 bg-white/90 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold text-green-600 shadow-sm">
              <ShieldCheck className="w-3 h-3" />
              Verified
            </span>
          )}
          <span className={`flex items-center gap-1 backdrop-blur px-3 py-1 rounded-full text-xs font-semibold shadow-sm ${
